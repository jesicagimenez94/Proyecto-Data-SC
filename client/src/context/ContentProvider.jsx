...
// // import jsonPath from '../data/data.json';
...
//         const jsonPath = await import("../data/data.json?url");
//         const response = await fetch(jsonPath.default); // ← Agrega .default
...
import contentData from '../data/data.json'; // ← Descomenta y usa esto
...
export const ContentProvider = ({ children }) => {
    // Estado para almacenar el contenido cargado desde el JSON
    const [content, setContent] = useState(contentData); // ← Usa directamente
    
    // Ya no necesitas useEffect ni fetch
